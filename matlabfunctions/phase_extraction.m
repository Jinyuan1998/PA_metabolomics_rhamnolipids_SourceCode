...
%% remove strains that do not grow
tblgc.F20590 = [];
tblgc.T36994 = [];

%% identify growth phases
phase_start_index = zeros(size(tblgc,2),3); % number of growth curves x 3
phase_start_time = zeros(size(tblgc,2),3); % number of growth curves x 3
